...
class StatusTransaksiInternetDanTvScreen extends StatelessWidget {
  const StatusTransaksiInternetDanTvScreen({super.key});
                ...
                Column(
                  children: [
                    CustomInputWithoutOutlineBorder(
                      label: "Produk",
                      inputValue: "Indihome Speedy dan TV",
                      isBold: true,
                    ),
                    CustomInputWithoutOutlineBorder(
                      label: "Sumber Dana",
