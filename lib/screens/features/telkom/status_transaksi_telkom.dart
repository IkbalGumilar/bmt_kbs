...
class StatusTransaksiTelkomScreen extends StatelessWidget {
  const StatusTransaksiTelkomScreen({super.key});
                ...
                Column(
                  children: [
                    CustomInputWithoutOutlineBorder(
                      label: "Produk",
                      inputValue: "Telkom - Telepon Rumah",
                      isBold: true,
                    ),
                    CustomInputWithoutOutlineBorder(
                      label: "Sumber Dana",
